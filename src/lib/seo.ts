...
export function getSportSEO(sportId: string): string {
  const content: Record<string, string> = {
    ...
    ncaaf: `Browse the complete NCAA Football schedule for today. Find all college football game times, matchups, and kickoff times. Stay updated with the latest NCAAF schedule information at Buffstreams Backup.`,
    ...
    ncaab: `Browse the complete NCAA Basketball schedule for today. Find all college basketball game times and matchups including March Madness. Stay updated with the latest NCAAB schedule information at Buffstreams Backup.`,
    wnba: `Browse the complete WNBA schedule for today. Find all WNBA game times, matchups, and tipoff times. Stay updated with the latest WNBA schedule information at Buffstreams Backup.`,
    ...
    boxing: `Browse today's boxing schedule. Find all boxing match times, title fights, and event information. Stay updated with the latest boxing schedule information at Buffstreams Backup.`,
    wwe: `Browse the complete WWE schedule for today. Find all WWE event times including Raw, SmackDown, and Pay-Per-View events. Stay updated with the latest WWE schedule information at Buffstreams Backup.`,
    mma: `Browse the complete MMA schedule for today. Find all MMA event times including Bellator, PFL, and ONE Championship. Stay updated with the latest MMA schedule information at Buffstreams Backup.`,
    ...
    nascar: `Browse the complete NASCAR schedule for today. Find all NASCAR race times including Cup Series, Xfinity, and Truck Series. Stay updated with the latest NASCAR schedule information at Buffstreams Backup.`,
    indycar: `Browse the complete IndyCar schedule for today. Find all IndyCar race times including the Indianapolis 500. Stay updated with the latest IndyCar schedule information at Buffstreams Backup.`,
    mls: `Browse the complete MLS schedule for today. Find all Major League Soccer match times and standings. Stay updated with the latest MLS schedule information at Buffstreams Backup.`,
